...
public class screen3D extends GamePanel{
    ...
    private int[] arraySolidWall = texture.readIntArrayFromFile("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Textures/Wall.txt");
    private HashMap<Integer, Color> colorsDoor;
    private int[] arrayDoor = texture.readIntArrayFromFile("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Textures/Door.txt");

    private HashMap<Integer, Color> colorsEnemy;
    private int[] arrayEnemy = texture.readIntArrayFromFile("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Textures/Enemy.txt");

    private HashMap<Integer, Color> colorsHappySerato;
    private int[] arrayHappySerato = texture.readIntArrayFromFile("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Textures/HappySerato.txt");

    private HashMap<Integer, Color> colorsSadSerato;
    private int[] arraySadSerato = texture.readIntArrayFromFile("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Textures/SadSerato.txt");
