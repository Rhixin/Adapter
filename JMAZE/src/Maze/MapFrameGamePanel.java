...
public class MapFrameGamePanel extends GamePanel implements Runnable, MouseListener {
    ...
    //<--------------GAME LOOP------------------->
    public void run() {
        Sound.play(new File("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Audio/bg_music.wav"), 1.5f);
    ...
    public void updateGameLogic(int curr_frame){
        ...
        try {
            bp.setBackgroundImage("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Animations/BulletSprites/bullet" + mainCharacter.gun.getBullets() + ".png");
            mainCharacter.gun.setBackgroundImage("C:/Users/Zhazted Rhixin/IdeaProjects/JMAZE/src/Animations/GunSprites/gun_" + mainCharacter.gun.current_animation_frame + ".png");
        } catch (IOException e){
        ...
        if( (game_changer == 5 || game_changer == 2 )&& !map.enemy.state && counter_instance == 0){
            ...
            if(game_changer == 2){
                try {
                    gsp.setBackgroundImage("src/Animations/Screens/sc1.png");
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }

                sd.play(new File("src/Audio/Victory.wav"), 1.5f);


            } else {
                try {
                    gsp.setBackgroundImage("src/Animations/Screens/sc2.png");
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }


                sd.play(new File("src/Audio/jumpscare.wav"), 1.5f);
